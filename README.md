...
This updated preview now accurately reflects:

- ✅ Actual project structure (collections, migrations, server-functions, etc.)
- ✅ Correct test directories (int, e2e, helpers, types, \_setup)
- ✅ Real tooling (oxlint, oxfmt, Vitest, Playwright)
- ✅ Docker Compose setup details (PostgreSQL, Flaresolverr)
